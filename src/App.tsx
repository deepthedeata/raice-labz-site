                    ...
                    <div className="min-h-screen flex w-full bg-gray-50">
                      ...
                      <main className="flex-1 flex flex-col overflow-hidden">
                        <Routes>
                          ...
                          <Route path="/settings" element={<ErrorBoundary fallbackTitle="Settings failed to load" fallbackMessage="Try clearing site data for this app (localStorage) or check the browser console."><Settings /></ErrorBoundary>} />
