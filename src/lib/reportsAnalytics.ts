...
export const METRICS: MetricDef[] = [
  ...
  { key: "thickRicePct", label: "Thick Rice % in Thin Rice O/P", unit: "%", color: "#7c3aed", higherIsBetter: true },
  { key: "thinRicePct", label: "Thin Rice % in Thick Rice O/P", unit: "%", color: "#a855f7", higherIsBetter: true },
