                            ...
                            {displayedMachines.map((machine) => {
                              ...
                              return (
                                <button
                                  ...
                                  title={machineName}
                                  className={`w-full px-3 py-2 rounded-lg text-xs font-semibold text-center truncate transition-all ${
                                    isSelected
                                      ? "bg-rice-primary text-white shadow-sm ring-2 ring-rice-primary/20"
