                      ...
                      {currentOutputParams ? (
                        <>
                          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            {[
                            ...
                            ].map((metric: { label: string; value: number; unit: string; border: string; bg: string; textColor: string; barColor: string; isCount?: boolean; img?: string }) => (
                              <div
                                key={metric.label}
                              ...
                              >
                                <div className="flex items-center gap-2">
                                  {metric.img && <GrainTypeIcon type={metric.img as "headrice" | "brokens" | "chalky" | "discolored" | "foreignmatter" | "immature"} />}
