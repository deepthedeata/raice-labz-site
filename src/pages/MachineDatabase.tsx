  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 overflow-auto p-6">
        ...
        {/* Machine table: Machine Name, Machine Number, Series Name, Custom Label, Status, Action */}
        <Card className="mt-6">
          <CardHeader>
            <CardTitle className="text-rice-primary flex items-center gap-2">
                  ...
                  <tbody>
                    {machineTableRows.map((row) => (
                      <tr key={`${row.lineIndex}-${row.entryIndex}`} className="border-b hover:bg-gray-50">
                        <td className="p-3 font-medium">{row.name}{row.machineNumber ? ` ${row.machineNumber}` : ""}</td>
