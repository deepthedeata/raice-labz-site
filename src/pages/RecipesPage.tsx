  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="px-6 py-6 max-w-[1200px] w-full mx-auto space-y-5">
        ...
        {/* Help / explanation */}
        <GroupedList title="About recipes">
          <GroupedRow
            icon={<Edit3 className="w-3.5 h-3.5" />}
            iconBg="hsl(var(--accent))"
            title="Save the boring parts"
            subtitle="Operator, mill, region, variety — fill once, reuse forever."
          />
          <GroupedRow
            icon={<Play className="w-3.5 h-3.5" />}
            iconBg="hsl(var(--ios-green))"
            title="One-tap launch"
            subtitle="Recipes pre-fill the analysis wizard so you skip Step 1."
          />
        </GroupedList>
      </div>
