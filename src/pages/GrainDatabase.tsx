...
const GrainDatabase = ({ embedded = false }: { embedded?: boolean }) => {
  ...
  const processOptionsSorted = useMemo(() => {
    ...
    const builtInFiltered = PROCESS_BUILTIN.filter((p) => !hiddenValues.has(p.value.toLowerCase()));
    const builtInValues = new Set(PROCESS_BUILTIN.map((o) => o.value.toLowerCase()));
    ...
    combined.push({ value: "others", label: "Others" });
    return combined;
  }, [savedCustomProcesses, hiddenProcesses]);
  ...
  const updateGeoProp = (key: string, value: string) => {
    setEditProps((prev) => ({
      ...prev,
      geoProperties: { ...prev.geoProperties, [key]: value },
    }));
  };
  ...
  const getProcessLabel = (value: string) => {
    const found = PROCESS_BUILTIN.find((p) => p.value === value);
    return found ? found.label : value;
  };
  ...
  const classificationTree = useMemo(() => {
    ...
    for (const entry of allEntries) {
      const cat = entry.category?.trim() || "Unspecified";
      const gt = entry.grainType?.trim() || "Unspecified";
                        ...
                        <CardContent>
                          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                            ...
                            <div className="space-y-2">
                              ...
                              <Input id="add-aspectRatio" type="number" placeholder="2.4" value={newEntryProps.geoProperties.aspectRatio} onChange={(e) => updateNewGeoProp("aspectRatio", e.target.value)} className="h-12" />
                            </div>
                            <div className="space-y-2">
            ...
            <Card className="lg:col-span-1">
              <CardHeader>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Category and grain type hierarchy from saved varieties
                </p>
              </CardHeader>
              <CardContent>
                {(() => {
        ...
        <DialogContent className="sm:max-w-6xl max-h-[95vh] overflow-y-auto">
          ...
          {selectedIndex !== null && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4">
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="db-aspectRatio" type="number" placeholder="2.4" value={editProps.geoProperties.aspectRatio} onChange={(e) => updateGeoProp("aspectRatio", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base text-rice-primary">Nutritional Properties</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="db-protein" className="font-medium">{t("knowGrains.protein")}</Label>
                      <Input id="db-protein" type="number" placeholder="7.2" value={editProps.chemicalProperties.protein} onChange={(e) => updateChemProp("protein", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-carbohydrate" className="font-medium">{t("knowGrains.carbohydrate")}</Label>
                      <Input id="db-carbohydrate" type="number" placeholder="78.9" value={editProps.chemicalProperties.carbohydrate} onChange={(e) => updateChemProp("carbohydrate", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-vitamin" className="font-medium">{t("knowGrains.vitamin")}</Label>
                      <Input id="db-vitamin" type="number" placeholder="0.4" value={editProps.chemicalProperties.vitamin} onChange={(e) => updateChemProp("vitamin", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-mineral" className="font-medium">{t("knowGrains.mineral")}</Label>
                      <Input id="db-mineral" type="number" placeholder="1.3" value={editProps.chemicalProperties.mineral} onChange={(e) => updateChemProp("mineral", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-lipids" className="font-medium">{t("knowGrains.lipids")}</Label>
                      <Input id="db-lipids" type="number" placeholder="2.8" value={editProps.chemicalProperties.lipids} onChange={(e) => updateChemProp("lipids", e.target.value)} className="h-12" />
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base text-rice-primary">GMAD Properties</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="db-gelatinization" className="font-medium">Gelatinization Temperature ({"\u00B0"}C)</Label>
                      <Input id="db-gelatinization" type="number" placeholder="65" value={editProps.gmadProperties.gelatinization} onChange={(e) => updateGmadProp("gelatinization", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-moisture" className="font-medium">{t("knowGrains.moisture")}</Label>
                      <Input id="db-moisture" type="number" placeholder="14.5" value={editProps.gmadProperties.moisture} onChange={(e) => updateGmadProp("moisture", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-age" className="font-medium">{t("knowGrains.age")}</Label>
                      <Input id="db-age" type="number" placeholder="6" value={editProps.gmadProperties.age} onChange={(e) => updateGmadProp("age", e.target.value)} className="h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="db-density" className="font-medium">Density (g/cm{"\u00B3"})</Label>
                      <Input id="db-density" type="number" placeholder="1.4" value={editProps.gmadProperties.density} onChange={(e) => updateGmadProp("density", e.target.value)} className="h-12" />
                    </div>
                  </div>
                </CardContent>
              </Card>
