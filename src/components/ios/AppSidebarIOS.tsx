...
const NAV: NavItem[] = [
  ...
  { titleKey: "Recipes", url: "/recipes", icon: Sparkles, group: "main" },
  ...
  { titleKey: "nav.manuals", url: "/manuals", icon: BookOpen, group: "admin" },
  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-5 pb-4 flex items-center gap-3">
        <div
          className="w-9 h-9 rounded-[10px] flex items-center justify-center font-bold text-[14px]"
          style={{
        ...
        <div>
          ...
          <div className="text-[10px] uppercase tracking-[0.12em] font-semibold" style={{ color: "hsl(var(--sidebar-foreground) / 0.55)" }}>
            Grain Analyzer
          </div>
        </div>
      </div>
