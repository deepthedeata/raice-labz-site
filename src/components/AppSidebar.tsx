...
const NAV: NavItem[] = [
  ...
  { titleKey: "nav.procurementAnalysis", url: "/procurement-analysis", icon: PaddyGrainIcon, group: "analysis" },
  { titleKey: "nav.productionAnalysis", url: "/production-analysis", icon: RiceProcessIcon, group: "analysis" },
